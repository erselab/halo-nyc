...
def main():
    ...
    plt.savefig("runs/natural_gas_correlation_length_check.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("plot -> runs/natural_gas_correlation_length_check.png")
    ...
    plt.savefig("runs/natural_gas_correlation_length_dx_map.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("plot -> runs/natural_gas_correlation_length_dx_map.png")
