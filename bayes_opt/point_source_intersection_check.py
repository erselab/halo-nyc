...
Run with the `analysis` conda env from the bayes_opt directory:
    /gpfs/fs1/home/scrowel3/miniforge3/envs/analysis/bin/python3 point_source_intersection_check.py
"""
...
def main():
    ...
    plt.savefig(f"runs/point_source_events_{FLIGHT}.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print(f"\nplot -> runs/point_source_events_{FLIGHT}.png")
