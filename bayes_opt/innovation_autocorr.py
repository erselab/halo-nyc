...
Usage (from bayes_opt/):
    python innovation_autocorr.py runs/20230726_1 runs/20230726_2
    python innovation_autocorr.py runs/*                 # every bundle under runs/
    python innovation_autocorr.py runs/* --out acf.png --max-dist 40 --nbins 40
    python innovation_autocorr.py runs/* --detrend       # remove along-track linear trend
"""
