...
def main():
    ...
    fig_scatter.savefig("runs/single_vs_joint_residual_scatter.png", bbox_inches="tight", dpi=110)
    plt.close(fig_scatter)
    fig_map.suptitle("Posterior residual maps: joint vs. single-flight solve, same color scale per flight")
    fig_map.savefig("runs/single_vs_joint_residual_maps.png", bbox_inches="tight", dpi=110)
    plt.close(fig_map)
    fig_flux.suptitle("Per-category posterior flux: prior vs. joint (6-flight) vs. single-flight solve")
    fig_flux.savefig("runs/single_vs_joint_flux_totals.png", bbox_inches="tight", dpi=110)
    plt.close(fig_flux)
    print("\nplots -> runs/single_vs_joint_residual_scatter.png, "
          "runs/single_vs_joint_residual_maps.png, runs/single_vs_joint_flux_totals.png")
