...
Run with the `analysis` conda env from the bayes_opt directory:
    /gpfs/fs1/home/scrowel3/miniforge3/envs/analysis/bin/python3 scripts/footprint_similarity_space_time.py
"""
...
def main():
    ...
    plt.savefig("figures/footprint_similarity_space_time.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("\nplot -> figures/footprint_similarity_space_time.png")
    ...
    plt.savefig("figures/footprint_similarity_time_slices.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("plot -> figures/footprint_similarity_time_slices.png")
    ...
    ax.legend(fontsize=8)
    plt.savefig("figures/footprint_similarity_decay_1d.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    ...
    plt.savefig("figures/footprint_similarity_decay_length.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("plots -> figures/footprint_similarity_decay_1d.png, "
          "figures/footprint_similarity_decay_length.png")
