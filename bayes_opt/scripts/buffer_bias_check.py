...
Run with the `analysis` conda env from the bayes_opt directory:
    /gpfs/fs1/home/scrowel3/miniforge3/envs/analysis/bin/python3 scripts/buffer_bias_check.py
"""
...
def main():
    ...
    plt.savefig("figures/buffer_overview.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("plot -> figures/buffer_overview.png")
...
def phase1_correlate(inv):
    ...
    plt.savefig("figures/buffer_bias_scatter.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("plot -> figures/buffer_bias_scatter.png")
    ...
    plt.savefig("figures/buffer_bias_map.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("plot -> figures/buffer_bias_map.png")
