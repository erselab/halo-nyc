...
def main():
    ...
    plt.savefig("figures/flight_sensitivity_maps.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    ...
    plt.savefig("figures/flight_sensitivity_similarity.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    ...
    plt.savefig("figures/flight_sensitivity_by_category.png", bbox_inches="tight", dpi=110)
    plt.close(fig)

    print("\nplots -> figures/flight_sensitivity_maps.png, figures/flight_sensitivity_similarity.png, "
          "figures/flight_sensitivity_by_category.png")
