...
def main():
    ...
    plt.savefig("figures/leg_level_prior_vs_posterior_check.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("\nplot -> figures/leg_level_prior_vs_posterior_check.png")
    ...
    for fid, c in colors.items():
        ax.scatter([], [], c=c, label=fid)
    ax.legend(fontsize=7)
    plt.savefig("figures/leg_level_abs_val_prior_vs_posterior_check.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("\nplot -> figures/leg_level_abs_val_prior_vs_posterior_check.png")
