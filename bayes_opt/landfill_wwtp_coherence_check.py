...
def main():
    ...
    plt.savefig("runs/landfill_wwtp_coherence.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("\nplot -> runs/landfill_wwtp_coherence.png")

    ax_map.set_title("Landfill/WWTP-dominated excursion events, all 6 flights")
    plt.savefig("runs/landfill_wwtp_events_map.png", bbox_inches="tight", dpi=110)
    plt.close(fig_map)
    print("plot -> runs/landfill_wwtp_events_map.png")
