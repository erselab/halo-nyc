...
Run with the `analysis` conda env from the bayes_opt directory:
    /gpfs/fs1/home/scrowel3/miniforge3/envs/analysis/bin/python3 along_track_scale_check.py
"""
...
def main():
    ...
    fig_ac.savefig("runs/along_track_autocorr.png", bbox_inches="tight", dpi=110)
    plt.close(fig_ac)
    fig_sf.suptitle("Along-track structure function: observed vs modeled enhancement")
    fig_sf.savefig("runs/along_track_structure.png", bbox_inches="tight", dpi=110)
    plt.close(fig_sf)
    print("\nplots -> runs/along_track_autocorr.png, runs/along_track_structure.png")
    ...
    ax.legend()
    plt.savefig("runs/along_track_structure_pooled.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("plot -> runs/along_track_structure_pooled.png")
