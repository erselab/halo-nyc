...
Run with the `analysis` conda env from the bayes_opt directory:
    /gpfs/fs1/home/scrowel3/miniforge3/envs/analysis/bin/python3 diffuse_prior_check.py
"""
...
def main():
    ...
    plt.savefig("runs/diffuse_prior_overview.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("\nplot -> runs/diffuse_prior_overview.png")
