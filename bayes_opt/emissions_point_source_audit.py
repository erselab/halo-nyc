...
def main():
    ...
    land_df.to_csv("runs/emissions_point_source_audit_landfill.csv", index=False)

    ww_df = audit_wastewater(lat, lon, m3t[wi])
    ww_missing = report(ww_df, "wastewater")
    ww_df.to_csv("runs/emissions_point_source_audit_wastewater.csv", index=False)
    ...
    plt.savefig("runs/emissions_point_source_audit_map.png", bbox_inches="tight", dpi=110)
    plt.close(fig)
    print("\nplot -> runs/emissions_point_source_audit_map.png")
    print("csvs -> runs/emissions_point_source_audit_landfill.csv, "
          "runs/emissions_point_source_audit_wastewater.csv")
